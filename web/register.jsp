                    ...
                    <div class="container-login100">
                        <div class="wrap-login100 p-t-90 p-b-30">
                            ...
                            <form action="MainController" class="login100-form validate-form" method="POST">
                                ...
                                <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter valid name">
                                ...
                                <div class="wrap-input100 validate-input m-b-20" data-validate = "Please enter password from 6 - 24 chars">
                                    ...
                                    <input id="password" class="input100" type="password" name="txtPassword" placeholder="Password">
                                    <span class="focus-input100"></span>
                                </div>

                                <div class="wrap-input100 validate-input m-b-20" data-validate = "Confirm password not match">
                                    <span class="btn-show-pass">
                                        <i class="fa fa fa-eye"></i>
                                    </span>
                                ...
                                <div class="container-login100-form-btn">
                                    <input type="submit" name="action" value="Register" class="login100-form-btn"/>
                                </div>
                                ...
                                <div class="flex-col-c p-t-50">
                                    ...
                                    <a href="login.jsp" class="txt3 bo1 hov1">
                                        Login now
                                    </a>
                                </div>
